### DADA2 Processing for barcode identification and relative abundance calculations for LB009 ###
...
#get sample names
sample.names <-  gsub('_EKDL230002083-1A_HTVMHDSX5_L1_1.fq.gz','',list.files(filtpathF, pattern="fq.gz", full.names = F))
sample.namesR <- gsub('_EKDL230002083-1A_HTVMHDSX5_L1_2.fq.gz','',list.files(filtpathR, pattern="fq.gz", full.names = F))
